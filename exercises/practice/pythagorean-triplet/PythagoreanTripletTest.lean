...
def pythagoreanTripletTests : TestSuite :=
 ...
 [168, 315, 357],
 [210, 280, 350],
 [240, 252, 348]] (PythagoreanTriplet.tripletsWithSum 840))
  |>.addTest "triplets for large number" (do
      return assertEqual [[1200, 14375, 14425],
 [1875, 14000, 14125],
 [5000, 12000, 13000],
 [6000, 11250, 12750],
 [7500, 10000, 12500]] (PythagoreanTriplet.tripletsWithSum 30000))
